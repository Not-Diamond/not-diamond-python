...
class TestReport:
    ...
    @parametrize
    def test_method_report_regenerated(self, client: NotDiamond) -> None:
        report = client.chat.report.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_report_regenerated_with_all_params(self, client: NotDiamond) -> None:
        report = client.chat.report.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_report_regenerated(self, client: NotDiamond) -> None:
        response = client.chat.report.with_raw_response.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_report_regenerated(self, client: NotDiamond) -> None:
        with client.chat.report.with_streaming_response.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
...
class TestAsyncReport:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_report_regenerated(self, async_client: AsyncNotDiamond) -> None:
        report = await async_client.chat.report.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_report_regenerated_with_all_params(self, async_client: AsyncNotDiamond) -> None:
        report = await async_client.chat.report.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_report_regenerated(self, async_client: AsyncNotDiamond) -> None:
        response = await async_client.chat.report.with_raw_response.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_report_regenerated(self, async_client: AsyncNotDiamond) -> None:
        async with async_client.chat.report.with_streaming_response.report_regenerated(
            provider={
                "model": "model",
                "provider": "provider",
            },
