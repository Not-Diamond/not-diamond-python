...
class TestReport:
    ...
    def test_method_evaluate_hallucination(self, client: NotDiamond) -> None:
        report = client.client.report.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
    ...
    def test_raw_response_evaluate_hallucination(self, client: NotDiamond) -> None:
        response = client.client.report.with_raw_response.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
    ...
    def test_streaming_response_evaluate_hallucination(self, client: NotDiamond) -> None:
        with client.client.report.with_streaming_response.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
...
class TestAsyncReport:
    ...
    async def test_method_evaluate_hallucination(self, async_client: AsyncNotDiamond) -> None:
        report = await async_client.client.report.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
    ...
    async def test_raw_response_evaluate_hallucination(self, async_client: AsyncNotDiamond) -> None:
        response = await async_client.client.report.with_raw_response.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
    ...
    async def test_streaming_response_evaluate_hallucination(self, async_client: AsyncNotDiamond) -> None:
        async with async_client.client.report.with_streaming_response.evaluate_hallucination(
            context="context",
            prompt="prompt",
            provider={
                "model": "gpt-4o",
