...
class TestPreferences:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_user_preference(self, client: NotDiamond) -> None:
        preference = client.preferences.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        )
        assert_matches_type(object, preference, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_user_preference(self, client: NotDiamond) -> None:
        response = client.preferences.with_raw_response.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_user_preference(self, client: NotDiamond) -> None:
        with client.preferences.with_streaming_response.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_retrieve_user_preference(self, client: NotDiamond) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.preferences.with_raw_response.retrieve_user_preference(
                user_id="",
                x_token="x-token",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_user_preference_by_id(self, client: NotDiamond) -> None:
        preference = client.preferences.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_user_preference_by_id(self, client: NotDiamond) -> None:
        response = client.preferences.with_raw_response.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_user_preference_by_id(self, client: NotDiamond) -> None:
        with client.preferences.with_streaming_response.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        ) as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_retrieve_user_preference_by_id(self, client: NotDiamond) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.preferences.with_raw_response.retrieve_user_preference_by_id(
                preference_id="preference_id",
                user_id="",
                x_token="x-token",
            )
...
class TestAsyncPreferences:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_user_preference(self, async_client: AsyncNotDiamond) -> None:
        preference = await async_client.preferences.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        )
        assert_matches_type(object, preference, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_user_preference(self, async_client: AsyncNotDiamond) -> None:
        response = await async_client.preferences.with_raw_response.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_user_preference(self, async_client: AsyncNotDiamond) -> None:
        async with async_client.preferences.with_streaming_response.retrieve_user_preference(
            user_id="user_id",
            x_token="x-token",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_retrieve_user_preference(self, async_client: AsyncNotDiamond) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.preferences.with_raw_response.retrieve_user_preference(
                user_id="",
                x_token="x-token",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_user_preference_by_id(self, async_client: AsyncNotDiamond) -> None:
        preference = await async_client.preferences.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_user_preference_by_id(self, async_client: AsyncNotDiamond) -> None:
        response = await async_client.preferences.with_raw_response.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_user_preference_by_id(self, async_client: AsyncNotDiamond) -> None:
        async with async_client.preferences.with_streaming_response.retrieve_user_preference_by_id(
            preference_id="preference_id",
            user_id="user_id",
            x_token="x-token",
        ) as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_retrieve_user_preference_by_id(self, async_client: AsyncNotDiamond) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.preferences.with_raw_response.retrieve_user_preference_by_id(
                preference_id="preference_id",
                user_id="",
                x_token="x-token",
            )
