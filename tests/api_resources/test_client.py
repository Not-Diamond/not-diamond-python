...
class TestClient:
    ...
    @parametrize
    def test_method_retrieve_root(self, client: NotDiamond) -> None:
        client_ = client.retrieve_root()
        assert_matches_type(RetrieveRootResponse, client_, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_root(self, client: NotDiamond) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_root(self, client: NotDiamond) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_root(self, async_client: AsyncNotDiamond) -> None:
        client = await async_client.retrieve_root()
        assert_matches_type(RetrieveRootResponse, client, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_root(self, async_client: AsyncNotDiamond) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_root(self, async_client: AsyncNotDiamond) -> None:
