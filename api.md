...
- <code title="get /v2/modelRouter/health">client.model_router.<a href="./src/not_diamond/resources/model_router.py">health_check</a>() -> object</code>
- <code title="post /v2/modelRouter/openHandsRouter">client.model_router.<a href="./src/not_diamond/resources/model_router.py">open_hands</a>(\*\*<a href="src/not_diamond/types/model_router_open_hands_params.py">params</a>) -> object</code>
...
- <code title="post /v2/prompt/estimateAdaptLLMRequests">client.prompt.<a href="./src/not_diamond/resources/prompt.py">estimate_adapt_llm_requests</a>(\*\*<a href="src/not_diamond/types/prompt_estimate_adapt_llm_requests_params.py">params</a>) -> <a href="./src/not_diamond/types/prompt_estimate_adapt_llm_requests_response.py">PromptEstimateAdaptLlmRequestsResponse</a></code>
...
- <code title="post /v2/chat/report/regenerated">client.chat.report.<a href="./src/not_diamond/resources/chat/report.py">regenerate_report</a>(\*\*<a href="src/not_diamond/types/chat/report_regenerate_report_params.py">params</a>) -> object</code>
...
- <code title="get /v1/llm-usage/summary">client.llm_usage.<a href="./src/not_diamond/resources/llm_usage.py">retrieve_summary</a>(\*\*<a href="src/not_diamond/types/llm_usage_retrieve_summary_params.py">params</a>) -> <a href="./src/not_diamond/types/llm_usage_retrieve_summary_response.py">LlmUsageRetrieveSummaryResponse</a></code>
...
```python
from not_diamond.types.admin import LlmUsageRetrieveDailyResponse, LlmUsageRetrieveSummaryResponse
```
...
- <code title="get /v1/admin/llm-usage/summary">client.admin.llm_usage.<a href="./src/not_diamond/resources/admin/llm_usage.py">retrieve_summary</a>(\*\*<a href="src/not_diamond/types/admin/llm_usage_retrieve_summary_params.py">params</a>) -> <a href="./src/not_diamond/types/admin/llm_usage_retrieve_summary_response.py">LlmUsageRetrieveSummaryResponse</a></code>
...
- <code title="get /posthog-debug">client.posthog_debug.<a href="./src/not_diamond/resources/posthog_debug.py">retrieve</a>() -> object</code>
