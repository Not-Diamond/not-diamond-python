...
__all__ = ["OptimizerSelectModelParams", "LlmProvider", "LlmProviderRequestProvider", "LlmProviderOpenRouterProvider"]


class OptimizerSelectModelParams(TypedDict, total=False):
