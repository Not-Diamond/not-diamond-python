...
__all__ = ["ModelRouterOpenHandsParams", "LlmProvider", "LlmProviderRequestProvider", "LlmProviderOpenRouterProvider"]


class ModelRouterOpenHandsParams(TypedDict, total=False):
