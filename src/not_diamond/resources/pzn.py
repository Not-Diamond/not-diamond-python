...
from ..types import pzn_train_custom_router_params, pzn_create_survey_response_params
    ...
    def create_survey_response(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, pzn_create_survey_response_params.PznCreateSurveyResponseParams),
            files=files,
    ...
    async def create_survey_response(
        ...
        *,
        ...
        return await self._post(
            "/v2/pzn/surveyResponse",
            body=await async_maybe_transform(body, pzn_create_survey_response_params.PznCreateSurveyResponseParams),
            files=files,
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
