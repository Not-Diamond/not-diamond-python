...
from ...types.chat import report_report_thumbs_params, report_regenerate_report_params
...
class ReportResource(SyncAPIResource):
    ...
    def regenerate_report(
        self,
        *,
        provider: report_regenerate_report_params.Provider,
        regenerated: bool,
        session_id: str,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                report_regenerate_report_params.ReportRegenerateReportParams,
            ),
    ...
    def report_thumbs(
        self,
        *,
        provider: report_report_thumbs_params.Provider,
        session_id: str,
        thumbs: int,
        user_id: Optional[str] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class ReportResourceWithRawResponse:
    def __init__(self, report: ReportResource) -> None:
        ...
        self.regenerate_report = to_raw_response_wrapper(
...
class AsyncReportResourceWithRawResponse:
    def __init__(self, report: AsyncReportResource) -> None:
        ...
        self.regenerate_report = async_to_raw_response_wrapper(
            report.regenerate_report,
        )
...
class ReportResourceWithStreamingResponse:
    def __init__(self, report: ReportResource) -> None:
        ...
        self.regenerate_report = to_streamed_response_wrapper(
            report.regenerate_report,
        )
...
class AsyncReportResourceWithStreamingResponse:
    def __init__(self, report: AsyncReportResource) -> None:
        ...
        self.regenerate_report = async_to_streamed_response_wrapper(
            report.regenerate_report,
        )
